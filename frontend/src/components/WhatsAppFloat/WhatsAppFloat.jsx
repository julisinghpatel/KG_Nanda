...
const WA_LINK = `whatsapp://send?phone=${WHATSAPP_NUMBER}&text=Hello!`;
...
export default function WhatsAppFloat() {
  ...
  return (
    <div className="wa-wrap">
      {/* Premium WhatsApp Popup Dialog */}
      <div className={`wa-popup-container ${popupOpen ? 'wa-popup-container--open' : ''}`}>
        {/* Header */}
        <div className="wa-popup-header">
          <div className="wa-header-left">
            ...
            <div className="wa-profile-pic">
              <svg viewBox="0 0 24 24" fill="#cfd8dc"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"></path></svg>
            </div>
            <div className="wa-header-info">
              <span className="wa-header-title">KG Nanda Hospital</span>
        ...
        <div className="wa-popup-body">
          <div className="wa-chat-bubble">
            <p className="wa-msg-text">
              <span role="img" aria-label="wave">👋</span> Namaste!<br/>
              Welcome to our<br/>
              Booking Service.<br/>
              Aap kya karna<br/>
              chahte hain?
            ...
            <div className="wa-msg-options">
              1. Appointment Book<br/>
              2. My Booking<br/>
              3. Cancel / Reschedule<br/>
              4. Talk to Support
            </div>
        ...
        <div className="wa-popup-footer">
          ...
          >
            <svg className="wa-btn-icon" viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
